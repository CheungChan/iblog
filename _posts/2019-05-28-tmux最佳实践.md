...
git clone https://github.com/tmux-plugins/tpm-sensible ~/.tmux/plugins/tpm-sensible
git clone https://github.com/tmux-plugins/tpm-resurrect ~/.tmux/plugins/tpm-resurrect
```
