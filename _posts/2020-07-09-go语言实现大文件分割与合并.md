...
![](http://img.azhangbaobao.cn/img/20200709170500.png)

后来尝试了很多工具，例如使用剪映把视频剪成几段，但是因为视频太大了，打开都崩溃。后来试着使用压缩工具压缩，可是压缩完还是很大，大于4G。（发稿时由变成5G了）

![](http://img.azhangbaobao.cn/img/20200709170728.png)
